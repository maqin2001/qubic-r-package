...
std::vector<Block> r_main_d(const std::vector<std::vector<short>> &x, const short r = 1, const double q = 0.06, const double c = 0.95, const int o = 100, const double f = 1, const int rk = 2, const bool d = true);
